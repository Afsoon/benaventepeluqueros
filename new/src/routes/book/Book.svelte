<svelte:head>
  <title>Benavente Peluqueros: Book</title>
</svelte:head>

<main class="w-full flex flex-wrap overflow-y-auto overflow-x-hidden">
  <div class="w-full relative bg-black-lighter text-white-light xl:max-h-sm">
  ...
  <div class="pt-16 w-full bg-white-lighter lg:flex lg:flex-col lg:items-center lg:justify-center">
    ...
    <script async defer src="https://embed.acuityscheduling.com/js/embed.js" type="text/javascript">
    </script>
  </div>
    ...
    <div class="w-full flex flex-col items-center md:flex-row">
      ...
      <div class="pt-2 md:pt-0 md:ml-auto md:block md:text-center md:mt-auto">
        <a
          ...
          alt="Página de la peluqueria en Facebook">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          alt="Perfil de de Instagram de la peluquería">
          <svg class="h-6 w-6 fill-current" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg"><path
